...
SECRET_KEY = 'django-insecure-(c$6xe78hhvgiqg3=$sfk241rnjl6xt63r@snhy#u&(hkm^yur'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Para admin e browser (opcional)
    ],
